...
# our CLI parser
    ...
    parser.add_argument("--datadir", type=str, default="C:/Users/gnard/Documents/v/testare_modello/cityscapes", help="directory the Cityscapes dataset is in")
    ...
    img_data = CityscapesDataset(args.datadir, split='test', mode='fine')
    ...
    file_model = "C:/Users/gnard/Documents/v/testare_modello/unet_4_epochs_depth.pkl"
    ...
    history_accuracy = []
    history_time = []
    for idx_batch, (imagergb, label_class, labelrgb) in enumerate(img_batch):  # we use in this script batch_size = 1 !!!
